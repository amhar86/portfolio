  ...
  const projects = [
    {
      ...
      description:
        "Developed an LIDAR-based 3D scanning system using a Time-of-Flight LiDAR sensor, a stepper motor, and an ARM Cortex-M4F microcontroller, enabling accurate and detailed indoor spatial mapping.",
    ...
    },
    {
      ...
      description:
        "Developed a responsive two-player Snake game using C++ and Object-Oriented Programming principles, ensuring seamless gameplay and efficient memory usage.",
      tech: ["C/C++"],
      link: "#",
    ...
    },
    {
      title: "Note-It",
      description:
        "Built a fully functional, responsive note-taking application using JavaScript, HTML, and CSS, featuring CRUD operations, light/dark mode, and local storage for efficient data persistence.",
  ...
  return (
    <section className="container mx-auto py-16">
      <motion.div
        ...
        transition={{
          duration: 0.7, // Adjust the timing of the animation
          ease: "easeInOut",
        }}
      >
